...
| Zone | Use |
|------|-----|
| Dry store | Flours, rice, pulses, sealed spices, hing, oils |
| Chill | Dairy, cut veg, cooked leftovers, sauces |
...
| Area | Target (typical commercial) |
|------|-----------------------------|
| Fridge | 0–5 °C |
| Freezer | −18 °C or below |
| Hot hold (if used) | ≥ 63 °C |

Log twice per shift or per local law. Escalate out-of-range readings immediately.

## 6. Cooked leftovers

1. Cool quickly in shallow containers (within site cooling SOP).
2. Cover, label, refrigerate.
3. Reheat once only to steaming hot (≥ 75 °C core unless local rule differs).
4. Do not add onion or garlic “to refresh” leftovers.

...
1. Clear a clean receiving table; have sanitiser, thermometer, and rejection tags ready.
2. Use trolley / sack truck (VV-02) — do not over-lift sacks alone.
...
## 3. High-risk supplier categories

| Category | Extra check |
|----------|-------------|
| Spice pastes / curry bases | Must be certified onion/garlic-free in writing |
| Stock cubes / bouillon | Allium-free only |
| Sauces (soy, chilli, ketchup) | Label check every new batch |
| Bread / wraps | No garlic dough, no onion seed topping unless approved |
| Ready sauces from caterers | Reject unless specification on file |
...
- Rejection log (product, lot, reason: allium / temperature / damage)  
- Supplier specification file for pastes and mixes  

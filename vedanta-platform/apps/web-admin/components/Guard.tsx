...
export default function Guard({ perm, children }: { perm: string; children: ReactNode }) {
  ...
  if (!ready || !user) return <div className="empty">Loading…</div>;
  if (!can(perm)) return <div className="empty">Your role doesn&apos;t have access to this screen.</div>;

...
export const FEATURE_FLAGS: FeatureFlag[] = [
  ...
  { id: "horoscope-chart", name: "Horoscope Chart", description: "Vedic kundli + Ashtakoot (36-guna) matching from birth details", state: "beta", minPlan: "free" },
  ...
  { id: "chat-folders", name: "Chat Folders", description: "Organise conversations", state: "enabled", minPlan: "free" },
  { id: "canvas", name: "Canvas", description: "Side panel document editor", state: "enabled", minPlan: "free" },

...
export const PRODUCT_CATALOG: ProductCatalog = {
  ...
  tools: [
    ...
    { id: "super-mode", name: "Super Mode", description: "Strongest models + agent tools + live web sources in one turn.", tier: "free", enabled: true },
    { id: "agent-mode", name: "Agent Mode", description: "Plan → tools → answer with RAG, memory, and connectors.", tier: "free", enabled: true },
    ...
    { id: "horoscope-chart", name: "Horoscope Chart", description: "Free Vedic kundli from birth date, time, and place — planets, houses, nakshatras, dasha.", tier: "free", enabled: true },
    ...
    { id: "voice", name: "Live Voice", description: "Realtime voice chat, speech input, and read-aloud.", tier: "free", enabled: true },
